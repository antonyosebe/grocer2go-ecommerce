            ...
            <nav>
                <ul class="primary-nav g-nav">
                    <li>
                        ...
                        Telephone: +0123456789</a>
                    </li>
                    <li>
                        <a href="mailto:info@grocer2go">
                        <i class="fas fa-envelope u-c-brand u-s-m-r-9"></i>
                        E-mail: test@grocer2go
                        </a>
                    </li>
                </ul>
            </nav>
            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        ...
                        <a href="{{ url('/') }}">
                        <!-- <img src="{{ asset('front/images/main-logo/main-logo.png') }}" alt="grocer2go" class="app-brand-logo"> -->


                            <span class="app-brand-logo">
                                <span class="logo-text">Grocer2Go</span>
                            </span>
