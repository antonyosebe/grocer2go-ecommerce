                        ...
                        <div class="details clearfix">
                            ...
                            <div class="data right">
                                ...
                                <div class="date">
                                    ...
                                    Order Amount: USD ' . $orderDetails['grand_total'] . '<br>
                            ...
                            foreach ($orderDetails['orders_products'] as $product) {
                                ...
                                $invoiceHTML .= '
                                    <tr>
                                        ...
                                        <td class="unit">USD ' . $product['product_price'] . '</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        if ($orderDetails['coupon_amount'] > 0) {
                                            // We CONCATENATE $invoiceHTML
                                            $invoiceHTML .= '<td class="total">USD '. $orderDetails['coupon_amount'] . '</td>';
                                        } else {
                                            // We CONCATENATE $invoiceHTML
                                            $invoiceHTML .= '<td class="total">USD 0</td>';
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td class="total">USD ' . $orderDetails['grand_total'] . '</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
